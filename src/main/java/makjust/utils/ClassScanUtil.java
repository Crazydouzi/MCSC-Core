...
public class ClassScanUtil {
     ...
     * @return Set
     */
    public static <A extends Annotation> Set<Class<?>> scanByAnnotation(String packageName, Class<A> annotation) throws UnsupportedEncodingException {
    ...
    private static Set<String> scanFile(URL url, String packageName) throws UnsupportedEncodingException {
        // 获取包的物理路径
